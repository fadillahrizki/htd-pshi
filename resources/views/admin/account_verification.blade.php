                            ...
                            <tr>
                                ...
                                <td>
                                    @if($account->status == 'Waiting')
                                        <a href="#" onclick="action(event, {{$account->id}}, 'verify')" class="btn btn-success" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Verify"> 
                                            <i class="mdi mdi-check"></i>
                                        </a>
                                        <a href="#" onclick="action(event, {{$account->id}}, 'reject')" class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Reject">
