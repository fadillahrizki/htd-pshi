...
@section('title', 'Edit Data Jaminan Sosial')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Edit Data Jaminan Sosial</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.jaminan-sosial.update', $model->id)}}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
