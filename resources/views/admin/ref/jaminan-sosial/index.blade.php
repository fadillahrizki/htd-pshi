            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Data Jaminan Sosial</li>
                    </ol>
                </div>
                <h4 class="page-title">Data Jaminan Sosial</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{route('admin.jaminan-sosial.create')}}" class="btn btn-primary">
                    ...
                    <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$data->nama}}</td>
                                <td>
                                    <a href="{{route('admin.jaminan-sosial.edit', $data->id)}}" class="btn btn-info" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit">
...
<form action="{{route('admin.jaminan-sosial.destroy', ':id')}}" method="POST" style="display: none;" id="form">
    @csrf
    @method('DELETE')
</form>
