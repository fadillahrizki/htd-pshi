        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('office.update', $dataUmum->id)}}" method="post" id="form-main">
                        @csrf
                        ...
                        <div id="basicwizard">
                            ...
                            <div class="tab-content b-0 mb-0">
                                ...
                                <div class="tab-pane" id="tab3">
                                    ...
                                    @include('perusahaan.partials.fasilitas')
                                ...
                                <div class="tab-pane" id="tab4">
                                    ...
                                    @include('perusahaan.partials.jamsos')
                                ...
                                <div class="tab-pane" id="tab5">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            @include('perusahaan.partials.hubungan_industri')

                                            <!-- Pelaksanaan Cuti -->
                                            @include('perusahaan.partials.cuti')
                                            
                                            <!-- Kasus / Perselisihan -->
                                            @include('perusahaan.partials.kasus')
                                        </div> <!-- end col -->
                                    </div> <!-- end row -->
