<div class="row">
    <div class="col-12">
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input @if(isset($bpjsKesehatan)) disabled @endif type="number" id="bpjs_kesehatan[jumlah_tenaga_kerja_laki_laki]" value="{{session('data_input') ? session('data_input')['bpjs_kesehatan']['jumlah_tenaga_kerja_laki_laki'] : ''}}" name="bpjs_kesehatan[jumlah_tenaga_kerja_laki_laki]" class="form-control @error('bpjs_kesehatan.jumlah_tenaga_kerja_laki_laki') is-invalid @enderror">
            </div>
        </div>
        <div class="row mb-3">
            <label class="col-md-3 col-form-label" for="bpjs_kesehatan[jumlah_tenaga_kerja_perempuan]">Jumlah Tenaga Kerja Perempuan</label>
            <div class="col-md-9">
                <input @if(isset($bpjsKesehatan)) disabled @endif type="number" id="bpjs_kesehatan[jumlah_tenaga_kerja_perempuan]" value="{{session('data_input') ? session('data_input')['bpjs_kesehatan']['jumlah_tenaga_kerja_perempuan'] : ''}}" name="bpjs_kesehatan[jumlah_tenaga_kerja_perempuan]" class="form-control @error('bpjs_kesehatan.jumlah_tenaga_kerja_perempuan') is-invalid @enderror">
            </div>
        </div>
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input @if(isset($bpjsKetenagakerjaan)) disabled @endif type="text" id="bpjs_ketenagakerjaan[no_bpjs_ketenagakerjaan_perusahaan]" value="{{session('data_input') ? session('data_input')['bpjs_ketenagakerjaan']['no_bpjs_ketenagakerjaan_perusahaan'] : ''}}" name="bpjs_ketenagakerjaan[no_bpjs_ketenagakerjaan_perusahaan]" class="form-control @error('bpjs_ketenagakerjaan.no_bpjs_ketenagakerjaan_perusahaan') is-invalid @enderror">
            </div>
        </div>
        <div class="row mb-3">
